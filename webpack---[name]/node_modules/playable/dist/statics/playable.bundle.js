(function(global, factory) {
    ...
    ***************************************************************************** */
    ...
    var makeFluidInterface = function(obj) {
        ...
        return {
            ...
            transient: function() {
                return setLifetime(Lifetime$1.TRANSIENT);
            },
            scoped: function() {
                return setLifetime(Lifetime$1.SCOPED);
            },
            singleton: function() {
                return setLifetime(Lifetime$1.SINGLETON);
            },
        };
    };
    ...
    var DependencyContainer = __assign({
    ...
    var isIPhone = function() {
        return !isIE() && IPHONE_PATTERN.test(getUserAgent());
    };
    var isIPod = function() {
        return !isIE() && IPOD_PATTERN.test(getUserAgent());
    };
    var isIPad = function() {
        return !isIE() && IPAD_PATTERN.test(getUserAgent());
    };
    var isIOS = function() {
        return isIPhone() || isIPod() || isIPad();
    };
    var isAndroid = function() {
        return ANDROID_PATTERN.test(getUserAgent());
    };
    var isSafari = function() {
        return SAFARI_PATTERN.test(getUserAgent());
    };

    var convertUIConfigForIOS = function(params) {
    ...
    var convertUIConfigForAndroid = function(params) {
        return (__assign({}, params, {
            disableControlWithClickOnPlayer: true,
            disableControlWithKeyboard: true
        }));
    ...
    var Player = /** @class */ (function() {
        function Player(params, scope, defaultModulesNames, additionalModuleNames, themeConfig) {
            if (defaultModulesNames === void 0) {
                defaultModulesNames = [];
            }
            if (additionalModuleNames === void 0) {
    ...
    */
    ...
    var engageInteractionTypeObserver = {
        engage: engage,
        disengage: disengage
    };
    ...
    function dot_tpl_src_modules_rootContainer_templates_container_dot(props) {
        var out = '<div data-playable-hook="player-container" tabindex="0" class="' + (props.styles.container) + '"></div>';
        return out;
    }
    ...
    var styles = {
        "controlButton": "root-container__controlButton___3nLjS",
        "hidden": "root-container__hidden___10ZXK",
        "container": "root-container__container____RXkJ",
        "fillAllSpace": "root-container__fillAllSpace___33wu6",
        "fullScreen": "root-container__fullScreen___3oMwD"
    };
    styleInject(css);
    ...
    var RootContainerView = /** @class */ (function(_super) {
        ...
        function RootContainerView(config) {
            ...
            var width = config.width,
                ...
                fillAllSpace = config.fillAllSpace,
                callbacks = config.callbacks;
            _this._callbacks = callbacks;
            _this._$rootElement = htmlToElement(dot_tpl_src_modules_rootContainer_templates_container_dot({
        ...
        RootContainerView.prototype.setFillAllSpaceFlag = function(isFillAllSpace) {
            if (isFillAllSpace === void 0) {
                isFillAllSpace = false;
            }
            if (isFillAllSpace) {
    ...
    function getQueriesForElement(element, prefix) {
        ...
        getQueries().forEach(function(query) {
            ...
            if (query.prefix === prefix &&
                !queries.some(function(_query) {
                    return _query.mode === query.mode && _query.width === query.width;
                })) {
                queries.push({
                    mode: query.mode,
                    width: query.width,
    ...
    var ElementQueries = /** @class */ (function() {
        function ElementQueries(element, _a) {
            var _b = (_a === void 0 ? {} : _a).prefix,
                prefix = _b === void 0 ? DEFAULT_QUERY_PREFIX : _b;
    ...
    var RootContainer = /** @class */ (function() {
        ...
        RootContainer.prototype._onResized = function() {
            ...
            this._eventEmitter.emitAsync(UIEvent$1.RESIZE, {
                width: width,
                height: height
            });
        };
        ...
        EventEmitterModule.prototype.bindEvents = function(eventsMap, defaultFnContext) {
            ...
            eventsMap.forEach(function(_a) {
                var eventName = _a[0],
                    fn = _a[1],
                    _b = _a[2],
                    fnContext = _b === void 0 ? defaultFnContext : _b;
            ...
            if (!isPromiseAvailable) {
                if (setImmediate) {
                    setImmediate(function() {
                        return _super.prototype.emit.apply(_this, [event].concat(args));
                    });
                } else {
                    setTimeout(function() {
                        return _super.prototype.emit.apply(_this, [event].concat(args));
    ...
    function hexToRgb(hex) {
        hex = hex.replace(SHORTHAND_HEX_COLOR_PATTERN, function(_, r, g, b) {
            return r + r + g + g + b + b;
        });
    ...
    var StyleSheet = /** @class */ (function() {
        ...
        StyleSheet.prototype._getRuleCSS = function(rule, ruleClassName) {
            ...
            var complexRuleNames = Object.keys(rule)
                .filter(function(ruleName) {
                    return typeof rule[ruleName] === 'object';
                })
        ...
        StyleSheet.prototype._getRuleStyles = function(rule) {
            var _this = this;
            var simpleRuleNames = Object.keys(rule).filter(function(ruleName) {
                return typeof rule[ruleName] !== 'object';
            });
    ...
    var LiveStateEngine = /** @class */ (function() {
        ...
        LiveStateEngine.prototype._bindEvents = function() {
            ...
            ].concat(SEEK_BY_UI_EVENTS.map(function(eventName) {
                return [eventName, _this._processSeekByUI];
            }), [
    ...
    function dot_tpl_src_modules_ui_debugPanel_templates_debugPanel_dot(props) {
        var out = '<div class="' + (props.styles.debugPanel) + '" data-playable-component> <div class="' + (props.styles.closeButton) + '" data-playable-hook="debug-panel-close-button" > x </div> <pre class="' + (props.styles.infoContainer) + '" data-playable-hook="debug-panel-info-container" > </pre></div>';
        return out;
    }
    ...
    var styles$1 = {
        "controlButton": "debug-panel__controlButton___pG-WY",
        "hidden": "debug-panel__hidden___1TRHR",
        "debugPanel": "debug-panel__debugPanel___116IW",
        "closeButton": "debug-panel__closeButton___claHV",
        "infoContainer": "debug-panel__infoContainer___-AZH_",
        "string": "debug-panel__string___1Jfzp",
        "number": "debug-panel__number___2WdLF",
        "boolean": "debug-panel__boolean___CpohN",
        "null": "debug-panel__null___2ZOuz",
        "key": "debug-panel__key___4avak"
    };
    styleInject(css$1);
        ...
        DebugPanel.prototype.getDebugInfo = function() {
            ...
            if (info.output === 'html5video') {
                var _a = info,
                    url = _a.url,
                    type = _a.type,
                    deliveryPriority = _a.deliveryPriority,
                    currentBitrate = _a.currentBitrate,
                    overallBufferLength = _a.overallBufferLength,
                    nearestBufferSegInfo = _a.nearestBufferSegInfo,
                    viewDimensions = _a.viewDimensions,
                    currentTime = _a.currentTime,
                    duration = _a.duration,
                    loadingStateTimestamps = _a.loadingStateTimestamps,
                    bitrates = _a.bitrates,
                    bwEstimate = _a.bwEstimate,
                    output = _a.output;
                return {
                    url: url,
                    type: type,
    ...
    function dot_tpl_src_modules_ui_screen_templates_screen_dot(props) {
        var out = '<div class="' + (props.styles.screen) + '" data-playable-hook="screen-block" data-playable-component> <canvas class="' + (props.styles.backgroundCanvas) + '" data-playable-hook="background-canvas"/></div>';
        return out;
    }
    ...
    var styles$2 = {
        "screen": "screen__screen___3BN2N",
        "regularMode": "screen__regularMode___1Bv69",
        "blurMode": "screen__blurMode___Zianj",
        "fillMode": "screen__fillMode___rToyv",
        "verticalStripes": "screen__verticalStripes___1tr7O",
        "horizontalStripes": "screen__horizontalStripes___1yh9M",
        "hiddenCursor": "screen__hiddenCursor___3-TwW",
        "backgroundCanvas": "screen__backgroundCanvas___1PHZh"
    };
    styleInject(css$2);
    ...
    var ScreenView = /** @class */ (function(_super) {
        ...
        function ScreenView(config) {
            ...
            var callbacks = config.callbacks,
                ...
                playbackViewElement = config.playbackViewElement;
            _this._callbacks = callbacks;
        ...
        ScreenView.prototype.resetAspectRatio = function() {
            var _a = this._$playbackElement,
                videoWidth = _a.videoWidth,
                videoHeight = _a.videoHeight;
            var _b = this._$rootElement.getBoundingClientRect(),
                width = _b.width,
                height = _b.height;
    ...
    var Screen = /** @class */ (function() {
        function Screen(_a) {
            var config = _a.config,
                eventEmitter = _a.eventEmitter,
                engine = _a.engine,
                fullScreenManager = _a.fullScreenManager,
                interactionIndicator = _a.interactionIndicator,
                rootContainer = _a.rootContainer;
            this._eventEmitter = eventEmitter;
            this._engine = engine;
    ...
    function dot_tpl_src_modules_ui_interactionIndicator_templates_container_dot(props) {
        var out = '<div class="' + (props.styles.iconContainer) + '" data-playable-component></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_interactionIndicator_templates_playIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg class="' + (props.styles.playIcon) + ' ' + (props.styles.animatedIcon) + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 14"> <path fill="#FFF" fill-rule="evenodd" d="M.079 0L0 14l10.5-7.181z"/> </svg></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_interactionIndicator_templates_pauseIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg class="' + (props.styles.pauseIcon) + ' ' + (props.styles.animatedIcon) + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14"> <path fill="#FFF" fill-rule="evenodd" d="M7 0h3v14H7V0zM0 0h3v14H0V0z"/> </svg></div>';
        return out;
    }
    ...
    function dot_tpl_src_modules_ui_interactionIndicator_templates_decreaseVolumeIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg class="' + (props.styles.animatedIcon) + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 14"> <g fill="none" fill-rule="evenodd"> <path fill="#FFF" d="M0 3.919h2.993v5.97H0V3.92zm2.995-.015L7 .924v12L2.995 9.882v-5.98z"/> <path stroke="#FFF" d="M9.853 10.837a5.45 5.45 0 0 0 0-7.707"/> </g> </svg></div>';
        return out;
    }
    ...
    var styles$3 = {
        "controlButton": "interaction-indicator__controlButton___2Y9N6",
        "hidden": "interaction-indicator__hidden___2uTS-",
        "iconContainer": "interaction-indicator__iconContainer___2r3Wb",
        "icon": "interaction-indicator__icon___1pjM4",
        "fadeOut": "interaction-indicator__fadeOut___P6kY6",
        "animatedIcon": "interaction-indicator__animatedIcon___3cK8N",
        "iconSize": "interaction-indicator__iconSize___IYB2z",
        "playIcon": "interaction-indicator__playIcon___1XtXN",
        "pauseIcon": "interaction-indicator__pauseIcon___qH2VX",
        "seconds": "interaction-indicator__seconds___2TlaJ"
    };
    styleInject(css$3);
    ...
    var styles$4 = {
        "controlButton": "overlay__controlButton___1ASmF",
        "hidden": "overlay__hidden___1Vt3d",
        "overlay": "overlay__overlay___3RC8o",
        "active": "overlay__active___3k0Mi",
        "poster": "overlay__poster___1mX3C",
        "icon": "overlay__icon___3zDVy",
        "transparency": "overlay__transparency___2CfdP"
    };
    styleInject(css$4);
    ...
    function dot_tpl_src_modules_ui_loader_templates_loader_dot(props) {
        var out = '<div class="' + (props.styles.loader) + ' ' + (props.styles.active) + '" data-playable-component data-playable-hook="loader" ></div>';
        return out;
    }
    ...
    var styles$5 = {
        "controlButton": "loader__controlButton___1YHb4",
        "hidden": "loader__hidden___3MeyV",
        "loader": "loader__loader___1J20N",
        "rotate": "loader__rotate___3K3Iv",
        "active": "loader__active___29tvY",
        "clip": "loader__clip___1RIdi",
        "clip-reverse": "loader__clip-reverse___20o6x"
    };
    styleInject(css$5);
    ...
    function dot_tpl_src_modules_ui_mainUiBlock_templates_mainUIBlock_dot(props) {
        var out = '<div class="' + (props.styles.mainUiBlock) + '" data-playable-component></div>';
        return out;
    }
    ...
    var styles$6 = {
        "mainUiBlock": "main-ui-block__mainUiBlock___3fUqI",
        "tooltipContainerWrapper": "main-ui-block__tooltipContainerWrapper___3e2KW"
    };
    styleInject(css$6);
    ...
    var MainUIBlock = /** @class */ (function() {
        function MainUIBlock(dependencies) {
            ...
            var config = dependencies.config,
                ...
                rootContainer = dependencies.rootContainer,
                tooltipService = dependencies.tooltipService,
                topBlock = dependencies.topBlock,
                bottomBlock = dependencies.bottomBlock,
        ...
        MainUIBlock.prototype._initUI = function(elements) {
            this.view = new MainUIBlock.View({
                elements: elements
            });
        };
    ...
    var styles$7 = {
        "controlButton": "top-block__controlButton___2Irx0",
        "hidden": "top-block__hidden___JNzhk",
        "topBlock": "top-block__topBlock___2nOmO",
        "activated": "top-block__activated___2ThkU",
        "titleContainer": "top-block__titleContainer___1gKBN",
        "background": "top-block__background___2RYBo",
        "liveIndicatorContainer": "top-block__liveIndicatorContainer___3wTlQ",
    ...
    var TopBlock = /** @class */ (function() {
        ...
        TopBlock.prototype._getElements = function(dependencies) {
            var title = dependencies.title,
                liveIndicator = dependencies.liveIndicator;
            return {
    ...
    function dot_tpl_src_modules_ui_title_templates_title_dot(props) {
        var out = '<div class="' + (props.styles.title) + ' ' + (props.themeStyles.titleText) + '" data-playable-hook="video-title"></div>';
        return out;
    }
    ...
    var styles$8 = {
        "controlButton": "title__controlButton___tyPdk",
        "hidden": "title__hidden___3SyPm",
        "title": "title__title___324Zx",
    ...
    var TitleView = /** @class */ (function(_super) {
        ...
        TitleView.prototype._initDOM = function() {
            this._$rootElement = htmlToElement(dot_tpl_src_modules_ui_title_templates_title_dot({
                styles: this.styleNames,
                themeStyles: this.themeStyles
            }));
        };
    ...
    function dot_tpl_src_modules_ui_liveIndicator_templates_liveIndicator_dot(props) {
        var out = '<div class="' + (props.styles.liveIndicator) + ' ' + (props.styles.hidden) + '"> <button tabindex="0" class="' + (props.styles.liveIndicatorButton) + '" aria-label="' + (props.texts.label || '') + '" data-playable-hook="live-indicator-button"> ' + (props.texts.text || '') + ' </button></div>';
        return out;
    }
    ...
    var styles$9 = {
        "controlButton": "live-indicator__controlButton___1FH60",
        "hidden": "live-indicator__hidden___1MQc0",
        "liveIndicator": "live-indicator__liveIndicator___3Vudz",
        "ended": "live-indicator__ended___18KqE",
        "active": "live-indicator__active___2Lobb",
        "clickable": "live-indicator__clickable___2efwz",
        "liveIndicatorButton": "live-indicator__liveIndicatorButton___fQcZU"
    };
    styleInject(css$9);
    ...
    var LiveIndicator = /** @class */ (function() {
        function LiveIndicator(_a) {
            var engine = _a.engine,
                eventEmitter = _a.eventEmitter,
                textMap = _a.textMap,
                tooltipService = _a.tooltipService;
            this._isHidden = true;
    ...
    var styles$10 = {
        "controlButton": "bottom-block__controlButton___2zYHZ",
        "hidden": "bottom-block__hidden___361S0",
        "bottomBlock": "bottom-block__bottomBlock___3Y_rW",
        "activated": "bottom-block__activated___YvJ-R",
        "progressBarContainer": "bottom-block__progressBarContainer___2CxAg",
        "controlsContainerLeft": "bottom-block__controlsContainerLeft___2Ozxp",
        "controlsContainerRight": "bottom-block__controlsContainerRight___qaM9T",
        "logoContainer": "bottom-block__logoContainer___1esHz",
        "background": "bottom-block__background___2ZL6j",
        "showLogoAlways": "bottom-block__showLogoAlways___2bJeD",
        "logoHidden": "bottom-block__logoHidden___2N6oy",
        "fullScreenContainer": "bottom-block__fullScreenContainer___3q_py",
        "playControlHidden": "bottom-block__playControlHidden___1mEi9",
        "playContainer": "bottom-block__playContainer___25g5A",
        "timeControlHidden": "bottom-block__timeControlHidden___32pcE",
        "timeContainer": "bottom-block__timeContainer___2N6cy",
        "volumeControlHidden": "bottom-block__volumeControlHidden___41JXw",
        "volumeContainer": "bottom-block__volumeContainer___1Zwk-",
        "fullScreenControlHidden": "bottom-block__fullScreenControlHidden___1jT2c",
        "progressControlHidden": "bottom-block__progressControlHidden___1rhHL",
        "downloadButtonHidden": "bottom-block__downloadButtonHidden___qisqf",
        "downloadContainer": "bottom-block__downloadContainer___2Gxyu",
        "pictureInPictureButtonHidden": "bottom-block__pictureInPictureButtonHidden___WY-f5",
        "pictureInPictureContainer": "bottom-block__pictureInPictureContainer___tOmqU",
        "elementsContainer": "bottom-block__elementsContainer___1MGej",
        "additionalButton": "bottom-block__additionalButton___39M0e"
    };
    styleInject(css$10);
    ...
    var BottomBlock = /** @class */ (function() {
        ...
        BottomBlock.prototype._getControlElements = function(dependencies) {
            var playControl = dependencies.playControl,
                progressControl = dependencies.progressControl,
                timeControl = dependencies.timeControl,
                volumeControl = dependencies.volumeControl,
                fullScreenControl = dependencies.fullScreenControl,
                logo = dependencies.logo,
                downloadButton = dependencies.downloadButton,
                pictureInPictureControl = dependencies.pictureInPictureControl;
            return {
        ...
        BottomBlock.prototype._bindEvents = function() {
            this._unbindEvents = this._eventEmitter.bindEvents([
                [UIEvent$1.FULL_SCREEN_STATE_CHANGED, this._removeFocusState]
            ], this);
        };
    ...
    function dot_tpl_src_modules_ui_core_tooltip_templates_tooltip_dot(props) {
        var out = '<div class="' + (props.styles.tooltip) + '" role="tooltip"> <div class="' + (props.styles.tooltipInner) + '" data-playable-hook="tooltip-inner"></div></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_core_tooltip_templates_tooltipContainer_dot(props) {
        var out = '<div class="' + (props.styles.tooltipContainer) + '" data-playable-component></div>';
        return out;
    }
    ...
    var styles$11 = {
        "controlButton": "tooltip__controlButton___E3x3L",
        "hidden": "tooltip__hidden___3R_Au",
        "tooltip": "tooltip__tooltip___1TO08",
        "showAsText": "tooltip__showAsText___3-qca",
        "tooltipVisible": "tooltip__tooltipVisible___37y2K",
        "tooltipInner": "tooltip__tooltipInner___2s85x"
    };
    styleInject(css$11);
    ...
    function getTooltipPositionByReferenceElement(tooltipReferenceElement, tooltipContainerElement, tooltipCenterXfn) {
        if (tooltipCenterXfn === void 0) {
            tooltipCenterXfn = calcTooltipCenterX;
        }
    ...
    var styles$12 = {
        "tooltipContainer": "tooltip-container__tooltipContainer___2guVa"
    };
    styleInject(css$12);
    ...
    var TooltipService = /** @class */ (function() {
        ...
        TooltipService.prototype._bindEvents = function() {
            this._unbindEvents = this._eventEmitter.bindEvents([
                [UIEvent$1.FULL_SCREEN_STATE_CHANGED, this.hide]
            ], this);
        };
        /**
    ...
    var styles$13 = {
        "controlButton": "progress__controlButton___2pi4V",
        "hidden": "progress__hidden___3Rjqh",
        "seekBlock": "progress__seekBlock___V4YqW",
        "inLive": "progress__inLive___3324R",
        "played": "progress__played___1dShL",
        "seekTo": "progress__seekTo___T0D_O",
        "syncButton": "progress__syncButton___3N1QN",
        "progressBarsWrapper": "progress__progressBarsWrapper___1SSlL",
        "isDragging": "progress__isDragging___2Tcb5",
        "timeIndicator": "progress__timeIndicator___2wltB",
        "seekButton": "progress__seekButton___3UtgF",
        "liveSync": "progress__liveSync___PIvwF",
        "seekButtonContainer": "progress__seekButtonContainer___1TZ8Z",
        "progressBar": "progress__progressBar___210E8",
        "buffered": "progress__buffered___2LiZB",
        "background": "progress__background___lqeL2",
        "timeIndicators": "progress__timeIndicators___c6h-a",
    ...
    var ProgressView = /** @class */ (function(_super) {
        ...
        function ProgressView(config) {
            var _this = this;
            var callbacks = config.callbacks,
                textMap = config.textMap,
                tooltipService = config.tooltipService,
                theme = config.theme;
            _this = _super.call(this, theme) || this;
            _this._callbacks = callbacks;
        ...
        ProgressView.prototype._setPlayedDOMAttributes = function(percent) {
            this._$rootElement.setAttribute('aria-valuetext', this._textMap.get(TextLabel$1.PROGRESS_CONTROL_VALUE, {
                percent: percent
            }));
    ...
    var ProgressControl = /** @class */ (function() {
        function ProgressControl(_a) {
            var engine = _a.engine,
                liveStateEngine = _a.liveStateEngine,
                eventEmitter = _a.eventEmitter,
                textMap = _a.textMap,
                tooltipService = _a.tooltipService,
                theme = _a.theme,
                previewThumbnail = _a.previewThumbnail,
                previewFullSize = _a.previewFullSize;
            this._engine = engine;
    ...
    function dot_tpl_src_modules_ui_controls_play_templates_playIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 14" preserveAspectRatio="xMidYMin slice" width="100%" style="padding-bottom: 127%; height: 1px; overflow: visible" > <!-- padding-bottom: 100% * height/width --> <path class="' + (props.themeStyles.playSvgFill) + '" d="M.079 0L0 14l10.5-7.181z"/> </svg></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_controls_play_templates_pauseIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" preserveAspectRatio="xMidYMin slice" width="100%" style="padding-bottom: 140%; height: 1px; overflow: visible" > <!-- padding-bottom: 100% * height/width --> <path class="' + (props.themeStyles.playSvgFill) + '" d="M7 0h3v14H7V0zM0 0h3v14H0V0z"/> </svg></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_controls_play_templates_control_dot(props) {
        var out = '<div class="' + (props.styles.playControl) + '" data-playable-hook="playback-control"> <button class="' + (props.styles.playbackToggle) + ' ' + (props.styles.controlButton) + '" data-playable-hook="playback-control" aria-label="' + (props.texts.label) + '" type="button" tabindex="0"/></div>';
        return out;
    }
    ...
    var styles$14 = {
        "controlButton": "play__controlButton___3PoOY",
        "hidden": "play__hidden___1tNO8",
        "playControl": "play__playControl___1AgWy",
        "playbackToggle": "play__playbackToggle___3tzyO",
        "icon": "play__icon___1z40F",
        "paused": "play__paused___2fI5f"
    };
    styleInject(css$14);
    ...
    function dot_tpl_src_modules_ui_controls_time_templates_time_dot(props) {
        var out = '<div data-playable-hook="time-control" class="' + (props.styles.timeWrapper) + ' ' + (props.themeStyles.timeText) + '"> <span data-playable-hook="current-time-indicator" class="' + (props.styles.time) + '"> </span> <span data-playable-hook="duration-time-indicator" class="' + (props.styles.time) + ' ' + (props.styles.duration) + '"> </span></div>';
        return out;
    }
    ...
    var styles$15 = {
        "controlButton": "time__controlButton___mpXuO",
        "hidden": "time__hidden___3xnRl",
        "timeWrapper": "time__timeWrapper___1r8hO",
        "time": "time__time___10Maj",
        "duration": "time__duration___3gaxd",
        "liveMode": "time__liveMode___2Nolg",
        "separator": "time__separator___hIpG9"
    };
    styleInject(css$15);
    ...
    var TimeView = /** @class */ (function(_super) {
        ...
        TimeView.prototype._initDOM = function() {
            this._$rootElement = htmlToElement(dot_tpl_src_modules_ui_controls_time_templates_time_dot({
                styles: this.styleNames,
                themeStyles: this.themeStyles
            }));
    ...
    var styles$16 = {
        "controlButton": "volume__controlButton___1XXXG",
        "hidden": "volume__hidden___504PW",
        "volumeControl": "volume__volumeControl___1f_-O",
        "volumeInputBlock": "volume__volumeInputBlock___EzZei",
        "isDragging": "volume__isDragging___3mlpX",
        "muteButton": "volume__muteButton___1d1Ei",
        "icon": "volume__icon___38qX4",
        "progressBar": "volume__progressBar___1JJYW",
        "volume": "volume__volume___1XvBT",
        "background": "volume__background___2Mafo",
        "hitbox": "volume__hitbox___1jBrF"
    };
    styleInject(css$16);
    ...
    var VolumeView = /** @class */ (function(_super) {
        ...
        VolumeView.prototype._setVolumeDOMAttributes = function(percent) {
            ...
            this._$volumeContainer.setAttribute('aria-valuetext', this._textMap.get(TextLabel$1.VOLUME_CONTROL_VALUE, {
                percent: percent
            }));
    ...
    var VolumeControl = /** @class */ (function() {
        ...
        VolumeControl.prototype._bindEvents = function() {
            this._unbindEvents = this._eventEmitter.bindEvents([
                [VideoEvent$1.SOUND_STATE_CHANGED, this._updateSoundState]
            ], this);
        };
    ...
    function dot_tpl_src_modules_ui_controls_fullScreen_templates_enterFullScreenIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15" preserveAspectRatio="xMidYMin slice" width="100%" style="padding-bottom: 100%; height: 1px; overflow: visible"> <!-- padding-bottom: 100% * height/width --> <path class="' + (props.themeStyles.fullScreenSvgFill) + '" fill-rule="evenodd" d="M2 10H0v4h4v-2H2v-2zM0 1v3h2V2h2V0H0v1zm14-1h-4v2h2v2h2V0zm-2 12h-2v2h4v-4h-2v2z"/> </svg></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_controls_fullScreen_templates_exitFullScreenIcon_dot(props) {
        var out = '<div class="' + (props.styles.icon) + '"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15" preserveAspectRatio="xMidYMin slice" width="100%" style="padding-bottom: 100%; height: 1px; overflow: visible" > <!-- padding-bottom: 100% * height/width --> <path class="' + (props.themeStyles.fullScreenSvgFill) + '" fill-rule="evenodd" d="M4 21h2v-6H0v2h4v4zM6 0H4v4H0v2h6V0zm9 6h6V4h-4V0h-2v6zm2 11h4v-2h-6v6h2v-4z"/> </svg></div>';
        return out;
    }

    function dot_tpl_src_modules_ui_controls_fullScreen_templates_control_dot(props) {
        var out = '<div class="' + (props.styles.fullScreenControl) + '" data-playable-hook="full-screen-control"> <button class="' + (props.styles.fullScreenToggle) + ' ' + (props.styles.controlButton) + '" data-playable-hook="full-screen-button" aria-label="' + (props.texts.label) + '" type="button" tabindex="0"/></div>';
        return out;
    }
    ...
    var styles$17 = {
        "controlButton": "full-screen__controlButton___3i-tz",
        "hidden": "full-screen__hidden___3BgVZ",
        "fullScreenControl": "full-screen__fullScreenControl___ng08Y",
        "fullScreenToggle": "full-screen__fullScreenToggle___2T_-2",
        "icon": "full-screen__icon___3x8Mv",
        "inFullScreen": "full-screen__inFullScreen___3F0AO"
    };
    styleInject(css$17);
    ...
    var FullScreenControl = /** @class */ (function() {
        ...
        FullScreenControl.prototype._bindEvents = function() {
            this._unbindEvents = this._eventEmitter.bindEvents([
                [UIEvent$1.FULL_SCREEN_STATE_CHANGED, this.view.setFullScreenState]
            ], this.view);
        };
    ...
    var styles$18 = {
        "controlButton": "picture-in-picture__controlButton___1gCAB",
        "hidden": "picture-in-picture__hidden___17cZh",
        "pictureInPictureControl": "picture-in-picture__pictureInPictureControl___3PS8W",
        "pictureInPictureToggle": "picture-in-picture__pictureInPictureToggle___68YJ9",
        "icon": "picture-in-picture__icon___HLiwK",
        "icon_small": "picture-in-picture__icon_small___2lbgz",
        "icon_big": "picture-in-picture__icon_big___3eWYY",
        "inPictureInPicture": "picture-in-picture__inPictureInPicture___33ewm"
    };
    styleInject(css$18);
    ...
    var PictureInPictureControl = /** @class */ (function() {
        function PictureInPictureControl(_a) {
            var eventEmitter = _a.eventEmitter,
                pictureInPicture = _a.pictureInPicture,
                textMap = _a.textMap,
                tooltipService = _a.tooltipService,
                theme = _a.theme;
            this._eventEmitter = eventEmitter;
    ...
    var styles$19 = {
        "controlButton": "logo__controlButton___owdbK",
        "hidden": "logo__hidden___Pm6t6",
        "logoWrapper": "logo__logoWrapper___2HWRo",
        "logoPlaceholder": "logo__logoPlaceholder___14fTk",
        "logoImage": "logo__logoImage___1N2ry",
        "logoButton": "logo__logoButton___1JWF4",
        "icon": "logo__icon___39sTd"
    };
    styleInject(css$19);
    ...
    var styles$20 = {
        "controlButton": "download__controlButton___fk1Ma",
        "hidden": "download__hidden___36lL8",
        "buttonWrapper": "download__buttonWrapper___244Vz",
        "downloadButton": "download__downloadButton___3J_rA",
        "icon": "download__icon___2Zjb8"
    };
    styleInject(css$20);
    ...
    var styles$21 = {
        "container": "preview-thumbnail__container___1TmLX",
        "empty": "preview-thumbnail__empty___LitJh",
        "highQualityFrame": "preview-thumbnail__highQualityFrame___sCDil",
        "lowQualityFrame": "preview-thumbnail__lowQualityFrame___fzXUI",
        "thumbText": "preview-thumbnail__thumbText___VFKJP"
    };
    styleInject(css$21);
    ...
    function dot_tpl_src_modules_ui_previewFullSize_templates_preview_dot(props) {
        var out = '<div class="' + (props.styles.container) + '" data-playable-component> <div class="' + (props.styles.frame) + '" data-playable-hook="preview-full-size-frame" > </div></div>';
        return out;
    }
    ...
    var styles$22 = {
        "controlButton": "preview-full-size__controlButton___2sWjc",
        "hidden": "preview-full-size__hidden___1ZRC_",
        "container": "preview-full-size__container___M_Ygb",
        "frame": "preview-full-size__frame___3AEDD"
    };
    styleInject(css$22);
    ...
    var NativeOutput = /** @class */ (function() {
        function NativeOutput(_a) {
            var eventEmitter = _a.eventEmitter,
                config = _a.config,
                _b = _a.availablePlaybackAdapters,
                availablePlaybackAdapters = _b === void 0 ? [] : _b;
        ...
        NativeOutput.prototype.setPreload = function(preload) {
            if (preload === void 0) {
                preload = exports.PRELOAD_TYPES.AUTO;
            }
        ...
        NativeOutput.prototype.getDebugInfo = function() {
            ...
            return __assign({}, adapterDebugInfo, {
                duration: duration,
                currentTime: currentTime,
            ...
            Object.defineProperty(NativeAdapter.prototype, "debugInfo", {
                get: function() {
                    if (this.video) {
                        ...
                        return __assign({}, this.mediaStreams[0], {
