...
exports.APP_LOAD_START_EVID = undefined;
...
var APP_LOAD_START_EVID = exports.APP_LOAD_START_EVID = 14;
...
var BiLoadStartDataItem = function(_BiBaseDataItem) {
    ...
    function BiLoadStartDataItem(sessionId) {
        ...
        return _possibleConstructorReturn(this, _BiBaseDataItem.call(this, APP_LOAD_START_EVID, sessionId));
    }
