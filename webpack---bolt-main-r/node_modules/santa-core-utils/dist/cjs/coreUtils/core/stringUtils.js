...
module.exports = {
     ...
     * @returns {string}
     */
    capitalize: function capitalize(string, lowerCaseElse) {
     ...
     * @returns {boolean}
     */
    endsWith: function endsWith(string, _endsWith, ignoreCase) {
        if (!string) {
            return false;
        }
        if (ignoreCase) {
            return this.endsWith(string.toLowerCase(), _endsWith.toLowerCase(), false);
        }
        return _.endsWith(string, _endsWith);
    },
