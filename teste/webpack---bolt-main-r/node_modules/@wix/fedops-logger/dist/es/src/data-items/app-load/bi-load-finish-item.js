...
exports.APP_LOAD_FINISH_EVID = undefined;
...
var APP_LOAD_FINISH_EVID = exports.APP_LOAD_FINISH_EVID = 11;
...
var BiLoadFinishDataItem = function(_BiBaseDataItem) {
    ...
    function BiLoadFinishDataItem(sessionId) {
        ...
        return _possibleConstructorReturn(this, _BiBaseDataItem.call(this, APP_LOAD_FINISH_EVID, sessionId));
    }
