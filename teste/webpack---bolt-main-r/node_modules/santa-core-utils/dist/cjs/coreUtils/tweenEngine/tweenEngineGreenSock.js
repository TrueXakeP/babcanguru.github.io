...
function create(tweenMax, TimelineMax) {
    ...
    function getTweensOf(element, isActive) {
        return tweenMax.getTweensOf(element, isActive);
    }
    ...
    function _from(elements, params) {
        ...
        var fromParams = _.defaults(params, params.from);
    ...
    function _to(elements, params) {
        ...
        var toParams = _.defaults(params, params.to || {});
...
//# sourceMappingURL=tweenEngineGreenSock.js.map