define("displayer", ["lodash", "coreUtils", "santa-components", "componentsCore", "prop-types", "skins", "reactDOM", "image-client-api"], function(t, e, i, r, o, a, p, n) {
    return function(t) {
        var e = {};
        ...
        696: function(t, e, i) {
            var r, o;
            r = [i(0), i(2), i(4), i(7), i(3), i(1), i(21), i(5), i(697)], void 0 === (o = function(t, e, i, r, o, a, p, n, s) {
                "use strict";
                var l = a.linkRenderer;
                ...
                function g(e) {
                    ...
                    return e.title && (i.alt = e.title), i
                }
                var m = {
                    displayName: "Displayer",
                    mixins: [o.mixins.skinBasedComp, o.mixins.skinInfo, o.mixins.createChildComponentMixin],
                    propTypes: t.assign({
                        browser: e.santaTypesDefinitions.Browser.browser.isRequired,
                        rootId: e.santaTypesDefinitions.Component.rootId.isRequired,
                        rootNavigationInfo: e.santaTypesDefinitions.Component.rootNavigationInfo.isRequired,
                        linkRenderInfo: e.santaTypesDefinitions.Link.renderInfo.isRequired,
                        isMobileView: e.santaTypesDefinitions.isMobileView,
                        isMobileDevice: e.santaTypesDefinitions.Device.isMobileDevice,
                        isAndroidOldBrowser: e.santaTypesDefinitions.mobile.isAndroidOldBrowser,
                        isExperimentOpen: e.santaTypesDefinitions.isExperimentOpen,
                        isResponsive: e.santaTypesDefinitions.RendererModel.isResponsive,
                        imageIndex: i.number.isRequired,
                        compProp: i.object.isRequired,
                        compData: i.object.isRequired,
                        imageWrapperSize: i.object.isRequired,
                        heightDiff: i.number,
                        widthDiff: i.number,
                        bottomGap: i.number,
                        galleryId: i.string,
                        isSelected: i.bool,
                        galleryDataId: i.string,
                        skin: i.string,
                        id: i.string,
                        showPanelState: i.string,
                        zoom: e.santaTypesDefinitions.NonPageItemZoom.zoom,
                        onClick: i.func
                    }, e.utils.santaTypesUtils.getSantaTypesFromPropTypes(e.components.Image.propTypes)),
                    getInitialState: function() {
                        return {
                            $showPanel: "defaultPanelState",
                            $displayDevice: this.props.isMobileView ? "mobileView" : "desktopView",
                            $textAlignmentState: d(this.props.compProp.alignText),
                    ...
                    _getImageClickAction: function() {
                        var t = this.props.compProp,
                            e = t.galleryImageOnClickAction;
                        return e || (e = !0 === t.expandEnabled ? "zoomMode" : "disabled"), e
                    },
                    componentWillUnmount: function() {
                        this._isMounted = !1
                    },
                    componentDidMount: function() {
                        this._isMounted = !0, setTimeout(function() {
                            var t = void 0;
                            this._isMounted && (this.setState({
                                $showPanel: this.props.showPanelState || "notShowPanel"
                            }), this.props.isAndroidOldBrowser && this.props.isMobileDevice && ((t = r.findDOMNode(this).classList).add("androidNativeBrowserFix"), t.remove("androidNativeBrowserFix")))
                        }.bind(this), 0)
                    },
                    componentWillReceiveProps: function(t) {
                        this.setState({
                            $selected: t.isSelected ? "selected" : "unselected"
                        })
                    },
                    getContainerSize: function() {
                        var t = this.props.imageWrapperSize.imageWrapperWidth - this.getDisplayerDefaultParam(this.props.skin, "imageWrapperRight") - this.getDisplayerDefaultParam(this.props.skin, "imageWrapperLeft"),
                            e = this.props.imageWrapperSize.imageWrapperHeight - this.getDisplayerDefaultParam(this.props.skin, "imageWrapperBottom") - this.getDisplayerDefaultParam(this.props.skin, "imageWrapperTop");
                        return this.getFromExports("addMarginToContainer") && (t += this.props.imageWrapperSize.imageWrapperMarginLeft + this.props.imageWrapperSize.imageWrapperMarginRight, e += this.props.imageWrapperSize.imageWrapperMarginTop + this.props.imageWrapperSize.imageWrapperMarginBottom), {
                            containerWidth: t,
                            containerHeight: e
                        }
                    },
                    getSkinProperties: function() {
                        ...
                        this.props.browser.ie && this.props.browser.version <= 10 && t.merge(d, {
                            border: "1px solid transparent"
                        });
                        var m = this.props.id + "Description";
                        return {
                            "": {
                                ...
                                "data-displayer-width": e.width,
                                "data-displayer-height": e.height,
                                "data-displayer-uri": e.uri,
                                ...
                                "data-is-responsive": r,
                                itemScope: !0,
                                style: this.props.isResponsive ? {
                                    position: "relative"
                                } : {},
                            ...
                            description: {
                                id: m,
                                children: this.parseTextIntoLinesArray(e.description) || "",
                                style: {
                                    textAlign: a
                                },
                                itemProp: "description"
                            },
                            image: this.createChildComponent(e, "core.components.Image", "image", t.assign({
                                ref: "image",
                                id: this.props.id + "image",
                                containerId: this.props.id + "imageWrapper",
                                describedById: m,
                                imageData: g(e),
                                displayMode: p.fittingTypes.SCALE_TO_FILL,
                                autoLayout: r,
                                wixImageLayout: r,
                                style: d
                            }, !r && {
                                containerWidth: s > 0 ? Math.round(s) : 16,
                                containerHeight: l > 0 ? Math.round(l) : 16
                            })),
                            zoom: {
                                style: {
                    ...
                    parseTextIntoLinesArray: function(i) {
                        if (t.isString(i)) {
                            var r = i.split(/(?:\r\n|\r|\n)/);
                            if (r.length > 1) {
                                var o = [];
                                return t.forEach(r, function(t, i) {
                                    o.push(t), i < r.length - 1 && o.push(e.utils.createReactElement("br", null))
                                }), o
                            }
                            return i
                        }
                    ...
                    getCursor: function() {
                        var t = this.props.compData,
                            e = this._getImageClickAction();
                        return "zoomMode" === e || t.link && "goToLink" === e ? "pointer" : "default"
                    },
                    getLinkData: function() {
                        return l.renderLink(this.props.compData.link, this.props.linkRenderInfo, this.props.rootNavigationInfo)
                    },
                    getDisplayerDefaultParam: function(e, i) {
                        var r = this.getSkinExports(),
                            o = n.skinsMap.get(e),
                            a = o.paramsDefaults ? o.paramsDefaults[i] : "";
                        if (!a) {
                            var p = r[i];
                            return p ? Math.abs(parseInt(p, 10) || 0) : 0
                        }
                        return Array.isArray(a) ? t.sumBy(a, function(t) {
                            return Math.abs(parseInt(this.getParamFromDefaultSkin(t).value, 10))
                        }.bind(this)) : Math.abs(parseInt(a, 10)) || 0
                    },
                    getLinkSkinPartDescriptor: function() {
                        var i = this.props.compData,
                            ...
                            p = {};
                        return p = "zoomMode" === r ? this.props.compData.galleryData ? {
                            onClick: function() {
                                this.props.zoom(this.props.compData, this.props.compData.galleryData)
                            }.bind(this)
                        } : l.renderImageZoomLink(this.props.linkRenderInfo, this.props.rootNavigationInfo, i, this.props.galleryDataId, void 0, this.props.galleryId) : i.link && "goToLink" === r ? this.getLinkData() : {
                            onClick: function(e) {
                                var i, r;
                                this.props.handleAction({
                                    type: "comp",
                                    name: a.siteConstants.ACTION_TYPES.ITEM_CLICKED,
                                    sourceId: this.props.galleryId,
                                    pageId: this.props.rootId
                                }, (i = t.get(this.props, "compData"), r = t.get(this.props, "imageIndex"), {
                                    item: i,
                                    timeStamp: a.loggingUtils.performance.now(),
                                    imageIndex: r,
                                    name: a.siteConstants.ACTION_TYPES.ITEM_CLICKED
                                })), e.preventDefault(), e.stopPropagation()
                            }.bind(this)
                        }, t.merge(o, p), "disabled" === r && (o.parentConst = e.utils.createReactElement.bind(null, "div")), o
                    },
                    setPanelState: function(t) {
                        this.setState({
                            $showPanel: t
                        })
                    },
                    ...
                    setTransitionPhase: function(t) {
                        this.setState({
                            $transitionPhase: t
                        })
                    }
                };
                return o.compRegistrar.register("wysiwyg.viewer.components.Displayer", m), n.skinsMap.addBatch(s), m
            }.apply(e, r)) || (t.exports = o)
        },
        697: function(t, e, i) {
            var r, o, a;
            "undefined" != typeof self && self, o = [], void 0 === (a = "function" == typeof(r = function() {
                "use strict";
                var t = {
                    ...
                    "wysiwyg.common.components.matrixgallery.viewer.skins.MatrixDisplayerSeparateTextBoxSkin": {
                        ...
                        css: {
                            ...
                            "%:hover %zoom": "opacity:1;[trans]",
                            "%[data-is-responsive=true] %link,%[data-is-responsive=true] %imageWrapper,%[data-is-responsive=true] %imgBorder,%[data-is-responsive=true] %image": "position:absolute;top:0;right:0;bottom:0;left:0;",
                            "%[data-is-responsive=true] wix-image": "position:absolute;top:0;right:0;bottom:[imgHeightDiff];left:0;"
                        }
                    },
                    "wysiwyg.common.components.matrixgallery.viewer.skins.MatrixDisplayerTextOnCenterSkin": {
                        ...
                        css: {
                            ...
                            "%[data-is-responsive=true] %link,%[data-is-responsive=true] %imageWrapper,%[data-is-responsive=true] %imgBorder,%[data-is-responsive=true] %image,%[data-is-responsive=true] wix-image": "position:absolute;top:0;right:0;bottom:0;left:0;"
                        }
                    },
                    ...
                    "wysiwyg.viewer.skins.gallerymatrix.PolaroidDisplayerCustomHeightSkin": {
                        ...
                        paramsDefaults: {
                            ...
                            imageWrapperTop: ["imagePadding"],
                            imageWrapperRight: ["imagePadding"],
                            imageWrapperLeft: ["imagePadding"]
                        },
                        paramsMutators: {
                            paddingTop: {
                                type: "decrease",
