define("skinExports", [], function() {
    return function(i) {
        ...
        return n.m = i, n.c = e, n.d = function(i, e, s) {
            n.o(i, e) || Object.defineProperty(i, e, {
                enumerable: !0,
                get: s
            })
        }, n.r = function(i) {
            ...
            if (n.r(s), Object.defineProperty(s, "default", {
                ...
                for (var r in i) n.d(s, r, function(e) {
                    return i[e]
                }.bind(null, r));
            return s
        }, n.n = function(i) {
        ...
        1055: function(i, e, n) {
            var s, r;
            s = [n(1056)], void 0 === (r = function(i) {
                "use strict";
                return i
            }.apply(e, s)) || (i.exports = r)
        },
        1056: function(i, e, n) {
            var s;
            void 0 === (s = function() {
                ...
                return {
                    ...
                    "wysiwyg.viewer.skins.LoginSocialButtonSkin": {
                        icon: {
                            skin: "wysiwyg.viewer.skins.IconSkin"
                        }
                    },
                    ...
                    "skins.viewer.mediaControlPlayDefaultSkin": {
                        icon: {
                            skin: "skins.viewer.VectorImageSkin"
                        }
                    },
                    ...
                    "skins.viewer.mediaControlsNoControlsSkin": {
                        volume: {
                            skin: "skins.viewer.mediaControlVolumeDefaultSkin"
                        }
                    },
                    "skins.viewer.mediaControlStoryboardMinimalSkin": {
                        icon: {
                            skin: "skins.viewer.VectorImageSkin"
                        }
                    },
                    "skins.viewer.mediaControlVolumeDefaultSkin": {
                        icon: {
                            skin: "skins.viewer.VectorImageSkin"
                        }
                    },
                    "skins.viewer.mediaOverlayControlsDefaultSkin": {
                        indicator: {
                            skin: "skins.viewer.VectorImageSkin"
                        }
                    },
