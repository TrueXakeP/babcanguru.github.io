define("wixFreemiumBanner", ["lodash", "coreUtils", "santa-components", "componentsCore", "prop-types", "react"], function(e, t, a, o, r, n) {
    return function(e) {
        var t = {};
        ...
        1382: function(e, t, a) {
            var o, r;
            o = [a(3), a(1383), a(1384)], void 0 === (r = function(e, t, a) {
                "use strict";
                return e.compRegistrar.register("wysiwyg.viewer.components.WixFreemiumBanner", t), e.compRegistrar.register("wysiwyg.viewer.components.WixFreemiumBanner2", a), {
                    banner: t,
                    banner2: a
                }
        ...
        1383: function(e, t, a) {
            ...
            o = [a(0), a(15), a(4), a(1), a(2), a(343), a(344)], void 0 === (r = function(e, t, a, o, r, i, s) {
                "use strict";
                var c = r.utils.createReactElement;

                function f(t, a, o) {
                    var r = c("path", {
                        d: "M.77.64l4.5 5.4-4.5 4.5"
                    });
                    return c("div", function(t, a, o) {
                        var r = {
                            className: t ? "desktop-bottom preview" : "desktop-bottom",
                            id: "bottom",
                            key: "desktopBottom",
                            "data-aid": o + "desktopBottom"
                        };
                        return t || e.assign(r, {
                            onClick: function() {
                    ...
                    }(o, a.desktopUrl, t), c("span", {
                        className: "contents"
                    }, a.bottomBanner1, c("span", {
                        className: "second"
                    }, a.bottomBanner3), c("svg", {
                        className: "arrow",
                ...
                function p(t, a, o, r) {
                    var n = function(t, a, o, r) {
                        var n = ["mobile-top"];
                        t || n.push("not-preview"), r && n.push("fixed-ad-mobile");
                        var i = {
                            className: n.join(" "),
                            id: "top",
                            key: "mobileTop",
                            "data-aid": o + "mobileTop",
                            style: {
                                height: 38,
                                display: "block"
                            }
                    ...
                    return c(o ? "div" : "a", n, a.mobileBanner1)
                }
                var d = function(e) {
                    function a() {
                        return function(e, t) {
                    ...
                    return function(e, t) {
                        ...
                        value: function() {
                            var e = this.props,
                                ...
                                d = e.isWixAdsAllowed,
                                l = e.metaSiteId,
                                b = e.isHeaderFixedPosition,
                                m = e.translations,
                                u = i.getWixFreemiumTranslations(m, n, l);
                            u.desktopUrl = u.desktopUrl + "&orig_msid=" + l, u.mobileUrl = u.mobileUrl + "&orig_msid=" + l;
                            var v = p(t, u, n, b),
                                x = function(e, t) {
                                    var a = {
                                    ...
                                    return c("a", a, t.topBanner1, c("div", {
                                        className: "hover1"
                                    }, t.topBannerHover1), c("div", {
                                        className: "hover2"
                                    }, t.topBannerHover2), c("svg", {
                                        className: "arrow",
                                        viewBox: "0 0 6.62 11.25"
                                    }, c("path", {
                                        d: "M.77.64l4.5 5.4-4.5 4.5"
                                ...
                                g = f(t, u, n),
                                h = r.utils.styleNodeUtils.generateStyleNode("wixAds-style", s),
                                w = {
                                    wrapper: !0,
                                    visible: d,
                                    hidden: !d
                                ...
                                y = {
                                    id: t,
                                    ref: "wrapper",
                                    className: o.classNames(w)
                                };
                            return c("div", y, a ? [h, v] : [h, x, g])
                        }
                    }]), a
                }();
                return d.displayName = "WixFreemiumBanner", d.propTypes = {
                    wixAdsId: a.string,
                    isMobileView: a.bool,
                    isPreview: a.bool,
                    isWixAdsAllowed: a.bool,
                    language: a.string,
                    metaSiteId: a.string,
                    isHeaderFixedPosition: a.bool,
                    translations: a.object
                }, d
            }.apply(t, o)) || (e.exports = r)
        },
        1384: function(e, t, a) {
            ...
            o = [a(0), a(15), a(1), a(4), a(2), a(343), a(344), a(1385)], void 0 === (r = function(e, t, a, o, r, i, s, c) {
                "use strict";
                var f = r.utils.createReactElement;

                function p(t, a, o, r, n) {
                    var i = ["desktop-top"];
                    t && i.push("preview"), n && i.push("overlay"), i.push(r);
                    var s = {
                        className: i.join(" "),
                        id: "top",
                        key: "desktopTop",
                        "data-aid": o + "desktopTop",
                        style: {
                            height: 50,
                            display: "flex"
                        }
                ...
                function d(t, a, o, r, n, i) {
                    var s = ["mobile-top"];
                    t && s.push("preview"), i && s.push("overlay"), r && s.push("fixed-ad-mobile"), s.push(n);
                    var c = {
                        className: s.join(" "),
                        id: "top",
                        key: "mobileTop",
                ...
                var l = function(e) {
                    return e.isWixAdsForOneApp && e.isMobileView && !e.isPreview
                };
                ...
                function b(e) {
                    var t = e.wixAdsId,
                        ...
                        o = e.isPreview,
                        r = e.metaSiteId,
                        n = e.isHeaderFixedPosition,
                        s = e.translations,
                        b = e.reportBI,
                        m = e.overlay,
                        u = e.direction;
                    if (m) return f("div", a ? d(o, null, t, n, u, m) : p(o, null, t, u, m));
                    var v = i.getWixFreemiumTranslations(s, o, r);
                    return v.desktopUrl2 = v.desktopUrl2 + "&orig_msid=" + r, v.mobileUrl2 = v.mobileUrl2 + "&orig_msid=" + r, l(e) ? f("a", function(e, t, a, o, r) {
                        var n = d(!1, e, t, a, r);
                        return Object.assign({}, n, {
                            className: n.className + " one-app-banner",
                            onClick: function() {
                                o(c.ONE_APP_FREE_BANNER_CLICK, {})
                            }
                        })
                    }(v.oneAppUrl, t, n, b, u), v.oneAppBanner) : a ? f(o ? "div" : "a", d(o, v.mobileUrl2, t, n, u), v.mobileBanner2) : f("a", p(o, v.desktopUrl2, t, u), f("span", {
                        className: "contents"
                    }, v.desktopBanner2Text, f("span", {
                        className: "button " + u
                    }, v.desktopBanner2Button)))
                }
                var m = function(e) {
                    function o() {
                        return function(e, t) {
                    ...
                    return function(e, t) {
                        ...
                        value: function() {
                            l(this.props) && this.props.reportBI(c.ONE_APP_FREE_BANNER_SHOWN, {})
                        }
                    }, {
                        key: "render",
                        value: function() {
                            var e = this.props,
                                ...
                                c = {
                                    ref: "wrapper",
                                    id: t,
                                    className: a.classNames(i)
                                },
                                p = [r.utils.styleNodeUtils.generateStyleNode("wixAds-style", s)];
                            return p.push(b(this.props)), f("div", c, p)
                        }
                    }]), o
                }();
                return m.displayName = "WixFreemiumBanner2", m.propTypes = {
                    wixAdsId: o.string,
                    isMobileView: o.bool,
                    isPreview: o.bool,
                    isWixAdsAllowed: o.bool,
                    language: o.string,
                    metaSiteId: o.string,
                    isHeaderFixedPosition: o.bool,
                    translations: o.object,
                    isWixAdsForOneApp: o.bool,
                    reportBI: o.func,
                    overlay: o.bool,
                    direction: o.string
                }, m
        ...
        1385: function(e) {
            e.exports = JSON.parse('{"ONE_APP_FREE_BANNER_SHOWN":{"eventId":428,"adapter":"ugc-viewer","src":42,"params":{"site_id":"site_id","vsi":"vsi"}},"ONE_APP_FREE_BANNER_CLICK":{"eventId":429,"adapter":"ugc-viewer","src":42,"params":{"site_id":"site_id","vsi":"vsi"}}}')
        },
        15: function(e, t) {
            e.exports = n
        },
        ...
        343: function(e, t, a) {
            var o, r;
            o = [a(0), a(2)], void 0 === (r = function(e, t) {
                "use strict";
                var a = t.utils.createReactElement,
                    o = "{Wix}",
                    ...
                    n = '<svg class="wix-logo" viewBox="0 0 28 10.89" alt="wix"><path d="M16.02.2c-.55.3-.76.78-.76 2.14a2.17 2.17 0 0 1 .7-.42 3 3 0 0 0 .7-.4A1.62 1.62 0 0 0 17.22 0a3 3 0 0 0-1.18.2z" class="dot"></path><path d="M12.77.52a2.12 2.12 0 0 0-.58 1l-1.5 5.8-1.3-4.75a4.06 4.06 0 0 0-.7-1.55 2.08 2.08 0 0 0-2.9 0 4.06 4.06 0 0 0-.7 1.55L3.9 7.32l-1.5-5.8a2.12 2.12 0 0 0-.6-1A2.6 2.6 0 0 0 0 .02l2.9 10.83a3.53 3.53 0 0 0 1.42-.17c.62-.33.92-.57 1.3-2 .33-1.33 1.26-5.2 1.35-5.47a.5.5 0 0 1 .34-.4.5.5 0 0 1 .4.5c.1.3 1 4.2 1.4 5.5.4 1.5.7 1.7 1.3 2a3.53 3.53 0 0 0 1.4.2l2.8-11a2.6 2.6 0 0 0-1.82.53zm4.43 1.26a1.76 1.76 0 0 1-.58.5c-.26.16-.52.26-.8.4a.82.82 0 0 0-.57.82v7.36a2.47 2.47 0 0 0 1.2-.15c.6-.3.75-.6.75-2V1.8zm7.16 3.68L28 .06a3.22 3.22 0 0 0-2.3.42 8.67 8.67 0 0 0-1 1.24l-1.34 1.93a.3.3 0 0 1-.57 0l-1.4-1.93a8.67 8.67 0 0 0-1-1.24 3.22 3.22 0 0 0-2.3-.43l3.6 5.4-3.7 5.4a3.54 3.54 0 0 0 2.32-.48 7.22 7.22 0 0 0 1-1.16l1.33-1.9a.3.3 0 0 1 .57 0l1.37 2a8.2 8.2 0 0 0 1 1.2 3.47 3.47 0 0 0 2.33.5z"></path></svg>',
                    i = '<svg class="download-logo" viewBox="0 0 177.32 142.49"><defs><style>.cls-1{fill:none;stroke:#9d288c;stroke-miterlimit:10;stroke-width:13px;}</style></defs><title>Artboard 1</title><path class="cls-1" d="M28.66,65.5V104s0,14.5,13,14.5h94.5s12.5-.5,12.5-13.5V65.5"/><path class="cls-1" d="M90.11,89.76v-75m-23,50.5,22,24.5,24-24"/></svg>';
                ...
                function c(e, t, r) {
                    var i = r ? "<span>" + n + '</span><span class="com" >.com</span>' : '<a href="' + t + '" target="_blank" rel="nofollow">' + n + '<span class="com" >.com</span></a>',
                        s = e.replace(o, i);
                    return a("span", {
                        className: "first",
                        dangerouslySetInnerHTML: {
                ...
                function f(e) {
                    return "//premium.wix.com/wix/api/premiumStart?siteGuid=" + e + "&referralAdditionalInfo=edhtml_PREVIEW_FREE_SITE_BANNER_CLICK"
                }

                function p(e) {
                    return "https://apps.wix.com/place-invites/join-lp/" + e + "?ref=free_banner"
                }
                return {
                    getWixFreemiumTranslations: function(e, t, d) {
                        return {
                            topBanner1: s(e.wix_ads_top_banner_1, "main", "div", r),
                            topBannerHover1: t ? e.wix_ads_top_banner_hover_3 : e.wix_ads_top_banner_hover_1,
                            topBannerHover2: t ? e.wix_ads_top_banner_hover_4 : e.wix_ads_top_banner_hover_2,
                            mobileBanner1: s(e.wix_ads_mobile_banner_1, "first", "span", n),
                            bottomBanner1: c(e.wix_ads_bottom_banner_1, e.Wix_Ads_Desktop_Bottom_Banner_Logo_URL, t),
                            bottomBanner3: e.wix_ads_bottom_banner_3,
                            desktopUrl: t ? f(d) : e.Wix_Ads_Desktop_URL,
                            mobileUrl: e.Wix_Ads_Mobile_URL,
                            desktopUrl2: t ? f(d) : e.Wix_Ads_Desktop_URL_NEW,
                            mobileUrl2: e.Wix_Ads_Mobile_URL_NEW,
                            desktopBanner2Text: t ? s(e.Wix_Ads_2_top_banner_hover_1, "text", "span") : (l = e.Wix_Ads_2_top_banner, b = '<div style="direction: ltr; display: inline-flex"><div>' + n + '</div><div class="com" >.com</div></div>', m = l.replace(o, b), a("span", {
                                className: "text",
                                dangerouslySetInnerHTML: {
                                    __html: m
                                }
                            })),
                            desktopBanner2Button: t ? e.Wix_Ads_2_top_banner_hover_CTA : e.Wix_Ads_2_top_banner_CTA,
                            mobileBanner2: s(e.wix_ads_mobile_banner_1, "content", "span", n),
                            oneAppUrl: p(d),
                            oneAppBanner: s(e.Mobile_Site_Banner_Widget + " " + i, "content", "span", n)
                        };
                        var l, b, m
                    }
                }
