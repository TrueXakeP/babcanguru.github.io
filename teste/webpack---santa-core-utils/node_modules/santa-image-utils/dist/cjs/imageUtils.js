...
var imageAnalyzer = require('./imageAnalyzer');
...
function getImageComputedProperties(imageClientApi, imageInfo, getMediaFullStaticUrl, currentUrl, devicePixelRatio, htmlTag) {
    ...
    var imageOptions = _.assign(_.pick(imageData, ['upscaleMethod']), _.pick(imageInfo, 'filters'), imageInfo.quality || imageData.quality);

    devicePixelRatio = getDevicePixelRatio(currentUrl, devicePixelRatio);

    var src = _.assign(_.pick(imageData, ['width', 'height', 'crop', 'name', 'focalPoint']), {
        id: imageData.uri
    });
    var target = {
