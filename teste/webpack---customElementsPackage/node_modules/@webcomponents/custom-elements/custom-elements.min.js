(function() {
    ...
    */
            ...
            if (c.nodeType === Node.ELEMENT_NODE) {
                ...
                if ("link" === f && "import" === e.getAttribute("rel")) {
                    ...
                    if (c instanceof Node && !d.has(c))
                        for (d.add(c), c = c.firstChild; c; c = c.nextSibling) q(c, b, d);
                    c = p(a, e);
                    continue
                } else if ("template" === f) {
                    c = p(a, e);
                ...
                if (e = e.__CE_shadowRoot)
                    for (e = e.firstChild; e; e = e.nextSibling) q(e, b, d)
            }
    ...
    function ba(a, b, d) {
        a.a.set(b, d);
        a.f.set(d.constructorFunction, d)
    }
    ...
    function y(a, b) {
        ...
        for (b = 0; b < d.length; b++) {
            var c = d[b];
            1 === c.__CE_state ? a.connectedCallback(c) : z(a, c)
        }
    }
    ...
    C.prototype.f = function(a) {
        ...
        "interactive" !== b && "complete" !== b || D(this);
        for (b = 0; b < a.length; b++)
            for (var d = a[b].addedNodes, c = 0; c < d.length; c++) B(this.c, d[c])
    };
    ...
    function da(a) {
        if (!1 !== a.b) {
            a.b = !1;
            for (var b = a.i, d = [], c = new Map, e = 0; e < b.length; e++) c.set(b[e].localName, []);
            B(a.a, document, {
                h: function(b) {
                    if (void 0 === b.__CE_state) {
                        var e = b.localName,
            ...
            for (e = 0; e < d.length; e++) z(a.a, d[e]);
            for (; 0 < b.length;) {
                var f = b.shift();
                e = f.localName;
                f = c.get(f.localName);
                for (var m = 0; m < f.length; m++) z(a.a, f[m]);
                (e = a.j.get(e)) && E(e)
            }
        }
    }
    ...
    F.prototype.m = function(a) {
        ...
        b = new ca;
        this.j.set(a, b);
        this.a.a.get(a) && !this.i.some(function(b) {
    ...
    function wa() {
        ...
        window.HTMLElement = function() {
            function b() {
                ...
                if (0 === e.length) return e = G.call(document, c.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = c, x(a, e), e;
                c = e.length - 1;
                var f = e[c];
    ...
    function Y(a, b, d) {
        function c(b) {
            return function(d) {
                ...
                b.apply(this, e);
                for (e = 0; e < f.length; e++) A(a, f[e]);
                if (l(this))
                    for (e = 0; e < c.length; e++) f = c[e], f instanceof Element && y(a, f)
            }
        }
        void 0 !== d.g && (b.prepend = c(d.g));
    ...
    function xa() {
        ...
        t(Document.prototype, "importNode", function(b, d) {
            b = ea.call(this, b, !!d);
            this.__CE_hasRegistry ? B(a, b) : w(a, b);
            return b
        });
    ...
    function ya() {
            ...
            Object.defineProperty(a, "textContent", {
                ...
                set: function(a) {
                    if (this.nodeType === Node.TEXT_NODE) c.set.call(this, a);
                        ...
                        c.set.call(this, a);
                        if (d)
                            for (a = 0; a < d.length; a++) A(b, d[a])
                    }
                }
            })
        }
        var b = X;
        t(Node.prototype, "insertBefore", function(a, c) {
            if (a instanceof DocumentFragment) {
                var e = Array.prototype.slice.apply(a.childNodes);
                a = K.call(this, a, c);
                if (l(this))
                    for (c = 0; c < e.length; c++) y(b, e[c]);
                return a
            }
            e = l(a);
            c = K.call(this, a, c);
        ...
        t(Node.prototype, "appendChild", function(a) {
            if (a instanceof DocumentFragment) {
                ...
                a = J.call(this, a);
                if (l(this))
                    for (var e = 0; e < c.length; e++) y(b, c[e]);
                return a
            }
            c = l(a);
            e = J.call(this, a);
        ...
        t(Node.prototype, "cloneNode", function(a) {
            a = I.call(this, !!a);
            this.ownerDocument.__CE_hasRegistry ? B(b, a) : w(b,
                a);
            return a
        });
        ...
        t(Node.prototype, "replaceChild", function(a, c) {
            if (a instanceof DocumentFragment) {
                ...
                a = M.call(this, a, c);
                if (l(this))
                    for (A(b, c), c = 0; c < e.length; c++) y(b, e[c]);
                return a
            }
            e = l(a);
            var f = M.call(this, a, c),
                d = l(this);
            d && A(b, c);
            e && A(b, a);
            d && y(b, a);
        ...
        N && N.get ? a(Node.prototype, N) : v(b, function(b) {
            a(b, {
                ...
                set: function(a) {
                    ...
                    null != a && "" !== a && J.call(this, document.createTextNode(a))
                }
            })
        })
    };
    ...
    function za(a) {
        function b(b) {
            return function(e) {
                ...
                b.apply(this, c);
                for (c = 0; c < k.length; c++) A(a, k[c]);
                if (l(this))
                    for (c = 0; c < d.length; c++) k = d[c], k instanceof Element && y(a, k)
            }
        }
        var d = Element.prototype;
        void 0 !== V && (d.before = b(V));
        void 0 !== V && (d.after = b(pa));
        void 0 !== qa &&
            t(d, "replaceWith", function(b) {
                for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
                d = [];
                ...
                k = l(this);
                qa.apply(this, c);
                for (c = 0; c < m.length; c++) A(a, m[c]);
                if (k)
                    for (A(a, this), c = 0; c < d.length; c++) m = d[c], m instanceof Element && y(a, m)
            });
    ...
    function Aa() {
        ...
        function d(a, b) {
            ...
            t(a, "insertAdjacentHTML", function(a, c) {
                ...
                else if ("afterend" === a) e = this.nextSibling, b.call(this, a, c), d(this.nextSibling,
                    e);
        ...
        ta ? b(HTMLElement.prototype,
            ta) : la ? b(Element.prototype, la) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
